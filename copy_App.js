        ...
        <div class="row">
                         ...
                         <li>
                            <label>
                              <input
                                ...
                                checked={this.state.flag === "NA"}
                                onChange={() => this.handleRadioChange("NA")} 
                              />
                              Regular Settings
                            </label>
                          </li>
         ...
         <div class="row">
               ...
               <div class="col-md-6">
                ...
                <textarea disabled={this.state.flag !== "NA"} id="values" placeholder={"{\"name\": \"John\", \"test\": true }"}  onChange={this.handleChange2.bind(this)}></textarea>
